...
public class DriverBackUp implements WebDriver, JavascriptExecutor, TakesScreenshot, WrapsDriver, HasInputDevices,
	...
	public DriverBackUp(String browser) {
		DriverBackUp driver = null;
		...
		if (browser.equals(Browser.Chrome)) {
			...
			driver = new DriverBackUp(e_driver);
	...
	public DriverBackUp(final WebDriver driver) {
	 ...
	 */
	public DriverBackUp register(WebDriverEventListener eventListener) {
	 ...
	 * @return this for method chaining.
	 */
	public DriverBackUp unregister(WebDriverEventListener eventListener) {
	...
	public String getCurrentUrl(String containsKey) {
		int times = 200;
		return this.getCurrentUrl(containsKey, times);
	}

	public String getCurrentUrl(String containsKey, int times) {
		Boolean x = false;
		int count = 0;
		while (x == false) {
...
//			by = By.xpath(this.getXPath(element));
	...
	public void tryClick(By by, int time) {
	...
	public void tryClick(By main, By vice) {
		int time = 20;
	...
	public String getSelectedCase(Map<By, String> map) {
		Boolean x = false;
		int count = 0;
		while (x == false) {
...
//		js.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", element);
	...
	private Object unpackWrappedElement(Object arg) {
		if (arg instanceof List<?>) {
			...
			return toReturn;
		} else if (arg instanceof ElementBackUp) {
			return ((ElementBackUp) arg).getWrappedElement();
		} else {
			return arg;
		}
	}
	...
	private Object wrapResult(Object result) {
		if (result instanceof WebElement) {
			return new ElementBackUp(this, (WebElement) result);
		}
	...
	ElementBackUp createWebElement(WebElement from, By by) {
		ElementBackUp finalElement = new ElementBackUp(this, from);
