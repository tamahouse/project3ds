...
public class MySoftAssertBackup implements IAssertLifecycle {
  ...
  public void onAssertSuccess(IAssert<?> assertCommand) {
	  ...
	  System.out.println(assertCommand.getMessage()+" expect {" + assertCommand.getActual()+ "} and actual {"+ assertCommand.getExpected()+ "}");
  }
