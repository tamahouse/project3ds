...
public class PS_allthegate_Test extends BaseTest{
	
	String shortcode = PS_shortcode.ALLTHEGATE;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_allthegate ps = (PS_allthegate) object;
		PS_allthegate2 ps2 = ps.getNewWindows();
