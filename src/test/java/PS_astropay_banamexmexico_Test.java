...
import automation.project3ds.PS_banamexmexico;
...
public class PS_astropay_banamexmexico_Test extends BaseTest{

	String shortcode = PS_shortcode.BANAMEXMEXICO;
	String co_id = "132";
//	String price = "5.00";
//	String currency = "BRL";
//	String url = "http://feature-pwl-2048.wallapi.bamboo.stuffio.com";
	...
	public void execute() throws Exception {
		...
		PS_banamexmexico ps = (PS_banamexmexico) object;
		ps.createPayment();
