...
public class PS_astropay_pagofacil_Test extends BaseTest{

	String shortcode = PS_shortcode.PAGOFACIL;
	String co_id = "11";
//	String url = "http://feature-pwl-2048.wallapi.bamboo.stuffio.com";
	...
	public void execute() throws Exception {
		...
		PS_pagofacil ps = (PS_pagofacil) object;
		PS_pagofacil2 ps2 = ps.getNewWindows();
		ps2.createPayment();
