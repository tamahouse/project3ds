...
import automation.project3ds.PS_redcompra;
import automation.project3ds.PS_redcompra2;
...
public class PS_astropay_redcompra_Test extends BaseTest{

	String shortcode = PS_shortcode.REDCOMPRA;
	String co_id = "43";
//	String price = "5.00";
//	String currency = "BRL";
//	String url = "http://feature-pwl-2048.wallapi.bamboo.stuffio.com";
	...
	public void execute() throws Exception {
		...
		PS_redcompra ps = (PS_redcompra) object;
		PS_redcompra2 ps2 = ps.getNewWindows();
		ps2.createPayment();
