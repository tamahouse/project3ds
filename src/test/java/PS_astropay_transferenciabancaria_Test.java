...
import automation.project3ds.PS_transferenciabancaria;
import automation.project3ds.Pslog;
import automation.project3ds.WidgetMulti;
import automation.project3ds.WidgetPage;


public class PS_astropay_transferenciabancaria_Test extends BaseTest{

	String shortcode = PS_shortcode.TRANSFERENCIABANCARIA;
	String co_id = "30";
	String price = "5.00";
	String currency = "BRL";
//	String url = "http://feature-pwl-2048.wallapi.bamboo.stuffio.com";
	...
	public void execute() throws Exception {
		...
		PS_transferenciabancaria ps = (PS_transferenciabancaria) object;
		ps.clickBank();
		ps.createPayment();
