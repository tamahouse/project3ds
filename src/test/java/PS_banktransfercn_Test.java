...
import automation.project3ds.PS_banktransfercn;
import automation.project3ds.PS_banktransfercn2;
...
import automation.project3ds.PS_unionpay;
import automation.project3ds.PS_unionpay2;
...
public class PS_banktransfercn_Test extends BaseTest{
	
	String shortcode = PS_shortcode.BANKTRANSFERCN;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_banktransfercn ps = (PS_banktransfercn) object;
		PS_banktransfercn2 ps2 = ps.getNewWindows();
		ps2.finishPayment();
