...
public class PS_cherrycredits_Test extends BaseTest{
	
	String shortcode = PS_shortcode.CHERRYCREDITS;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_cherrycredits ps = (PS_cherrycredits) object;
		PS_cherrycredits2 ps2 = ps.getNewWindows();
