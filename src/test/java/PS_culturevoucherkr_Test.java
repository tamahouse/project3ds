...
import automation.project3ds.PS_culturevoucherkr;
...
public class PS_culturevoucherkr_Test extends BaseTest{
	
	String shortcode = PS_shortcode.CULTUREVOUCHERKR;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_culturevoucherkr ps = (PS_culturevoucherkr) object;
		ps.createPayment();
