...
import automation.project3ds.PS_dotpaymt2;
...
public class PS_dotpay_dotpaymt_Test extends BaseTest{
	
	String shortcode = PS_shortcode.DOTPAYMT;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_dotpaymt ps = (PS_dotpaymt) object;
		PS_dotpaymt2 ps2 = ps.createPayment();
		ps2.finishPayment();
