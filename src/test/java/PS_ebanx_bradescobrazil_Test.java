...
import automation.project3ds.PS_bradescobrazil;
...
public class PS_ebanx_bradescobrazil_Test extends BaseTest{

	String shortcode = PS_shortcode.BRADESCOBRAZIL;
	String co_id = "30";
//	String url = "http://feature-pwl-2048.wallapi.bamboo.stuffio.com";
	...
	public void execute() throws Exception {
		...
		PS_bradescobrazil ps = (PS_bradescobrazil) widgetMulti.getPS(shortcode);
		PS_ebanx2 ps2 = ps.createPaymentWithRadio();
