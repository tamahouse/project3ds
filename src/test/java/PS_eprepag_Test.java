...
import automation.project3ds.PS_eprepag;
...
public class PS_eprepag_Test extends BaseTest{
	
	String shortcode = PS_shortcode.TODITO;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_eprepag ps = (PS_eprepag) object;
		ps.createPayment();
