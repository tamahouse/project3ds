...
public class PS_gateway_old_Test_3dsOFF {
...
//		String cardNumber = "5200000000001096";
		...
		PS_gateway_old.co_id = co_id;
		PS_gateway_old.cardNumber = cardNumber;
		PS_gateway_old.createPayment();
		PS_gateway_old.finish3dsPolkOFF();
