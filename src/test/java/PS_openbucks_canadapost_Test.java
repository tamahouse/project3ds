...
public class PS_openbucks_canadapost_Test extends BaseTest{
	
	String shortcode = PS_shortcode.CANADAPOST;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_canadapost ps = (PS_canadapost) object;
		PS_canadapost2 ps2 = ps.getNewWindows();
//		ps2.finishPayment();
