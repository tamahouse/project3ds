...
public class PS_openbucks_moneygram_Test extends BaseTest{
	
	String shortcode = PS_shortcode.MONEYGRAM;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_moneygram ps = (PS_moneygram) object;
		PS_moneygram2 ps2 = ps.getNewWindows();
		ps2.finishPayment();
