...
public class PS_openbucks_walmart_Test extends BaseTest{
	
	String shortcode = PS_shortcode.WALMART;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_walmart ps = (PS_walmart) object;
		PS_walmart2 ps2 = ps.getNewWindows();
		ps2.finishPayment();
