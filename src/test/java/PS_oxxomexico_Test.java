...
import automation.project3ds.PS_oxxomexico;
...
public class PS_oxxomexico_Test extends BaseTest{
	
	String shortcode = PS_shortcode.OXXOMEXICO;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_oxxomexico ps = (PS_oxxomexico) object;
		ps.createPayment();
