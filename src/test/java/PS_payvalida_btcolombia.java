...
import automation.project3ds.PS_btcolombia;
...
public class PS_payvalida_btcolombia extends BaseTest{
	
	String shortcode = PS_shortcode.BTCOLOMBIA;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_btcolombia ps = (PS_btcolombia) object;
		ps.createPayment();
