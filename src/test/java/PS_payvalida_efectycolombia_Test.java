...
public class PS_payvalida_efectycolombia_Test extends BaseTest{
	
	String shortcode = PS_shortcode.EFECTYCOLOMBIA;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_efectycolombia ps = (PS_efectycolombia) object;
		ps.createPayment();
