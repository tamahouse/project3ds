...
import automation.project3ds.PS_evroset;
...
import automation.project3ds.PS_sepadirectdebit;
...
public class PS_sepadirectdebit_Test extends BaseTest{
	
	String shortcode = PS_shortcode.SEPADIRECTDEBIT;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_sepadirectdebit ps = (PS_sepadirectdebit) object;
		ps.createPayment();
