...
import automation.project3ds.PS_svyasnoi;
...
public class PS_svyasnoi_Test extends BaseTest{
	
	String shortcode = PS_shortcode.SVYASNOI;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_svyasnoi ps = (PS_svyasnoi) object;
		ps.createPayment();
