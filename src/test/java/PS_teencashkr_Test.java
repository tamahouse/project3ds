...
import automation.project3ds.PS_teencashkr;
...
public class PS_teencashkr_Test extends BaseTest{
	
	String shortcode = PS_shortcode.TEENCASHKR;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_teencashkr ps = (PS_teencashkr) object;
		ps.createPayment();
