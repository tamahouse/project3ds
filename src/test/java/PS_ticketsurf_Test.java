...
import automation.project3ds.PS_ticketsurf;
...
public class PS_ticketsurf_Test extends BaseTest{
	
	String shortcode = PS_shortcode.TICKETSURF;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_ticketsurf ps = (PS_ticketsurf) object;
		ps.createPayment();
