...
public class PS_unionpay_Test extends BaseTest{
	
	String shortcode = PS_shortcode.UNIONPAY;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_unionpay ps = (PS_unionpay) object;
		PS_unionpay2 ps2 = ps.getNewWindows();
