...
public class PS_webmoney_Test extends BaseTest{
	
	String shortcode = PS_shortcode.WEBMONEY;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_webmoney ps = (PS_webmoney) object;
		PS_webmoney2 ps2 = ps.getNewWindows();
