...
import automation.project3ds.PS_wechatpayments;
...
public class PS_wechatpayments_Test extends BaseTest{
	
	String shortcode = PS_shortcode.WECHATPAYMENTS;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_wechatpayments ps = (PS_wechatpayments) object;
		ps.createPayment();
		String cl_id = Pslog.get_cl_id_email_Fasterpay("weixin");
