...
public class PS_yandex_yamoney_Test extends BaseTest{
	
	String shortcode = PS_shortcode.YAMONEY;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_yamoney ps = (PS_yamoney) object;
		PS_yamoney2 ps2 = ps.getNewWindows();
