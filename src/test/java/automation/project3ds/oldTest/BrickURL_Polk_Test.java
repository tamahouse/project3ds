...
public class BrickURL_Polk_Test {
...
//	final String hostBrickHTML = "http://feature-pwg-1108.wallapi.bamboo.stuffio.com/brick/test-staging/brick.html";
	final String hostBrickURL = "http://feature-brick-test.wallapi.bamboo.stuffio.com/brick/test-staging/brick-custom-polk.html";
...
//		String PAN = map.get("PAN");
	...
	public void execute(String cardNumber, String host) throws Exception {
		...
		driver.get(host);
		PageBrickURL.submitPolk(cardNumber);
