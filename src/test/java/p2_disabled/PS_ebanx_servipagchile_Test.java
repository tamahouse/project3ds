...
public class PS_ebanx_servipagchile_Test extends BaseTest{

	String shortcode = PS_shortcode.SERVIPAGCHILE;
	String co_id = "43";
//	String url = "http://feature-pwl-2048.wallapi.bamboo.stuffio.com";
	String host = AnnotationPage.WallapiUrl.host(url).widget(widget).co_id(co_id).isPrice(price, currency).generate();
	...
	public void execute() throws Exception {
		...
		PS_servipagchile ps = (PS_servipagchile) object;
