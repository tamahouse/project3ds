...
import automation.project3ds.PS_btperu;
import automation.project3ds.PS_cherrycredits;
import automation.project3ds.PS_cherrycredits2;
import automation.project3ds.PS_efectycolombia;
import automation.project3ds.PS_epinpaymentsystem;
import automation.project3ds.PS_mobilegateway;
...
public class PS_epinpaymentsystem_Test extends BaseTest{
	
	String shortcode = PS_shortcode.EPINPAYMENTSYSTEM;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_epinpaymentsystem ps = (PS_epinpaymentsystem) object;
		ps.createPayment();
		widgetPage.waitForThankyou(widget);
		String pin = ps.getPin();
		String cl_id = Pslog.get_cl_id_email_Fasterpay(pin);
