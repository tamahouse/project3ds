...
import automation.project3ds.PS_bancontact;
import automation.project3ds.PS_bancontact2;
...
public class PS_mollie_bancontact_Test extends BaseTest{
	
	String shortcode = PS_shortcode.BANCONTACT;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_bancontact ps = (PS_bancontact) object;
		PS_bancontact2 ps2 = ps.getNewWindows();
		ps2.createPayment();
