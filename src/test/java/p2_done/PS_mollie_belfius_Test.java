...
import automation.project3ds.PS_belfius;
import automation.project3ds.PS_belfius2;
...
public class PS_mollie_belfius_Test extends BaseTest{
	...
	String shortcode = PS_shortcode.BELFIUS;
...
//	}
	...
	public void execute() throws Exception {
		...
		PS_belfius ps = (PS_belfius) object;
		PS_belfius2 ps2 = ps.getNewWindows();
		ps2.createPayment();
