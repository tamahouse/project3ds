...
public class PS_przelewy24_SelectBank_Test extends BaseTest{
	...
	public void execute() throws Exception {
		...
		PS_przelewy24_2 ps2 = ps.createPaymentWithSelectBank();
		ThankyouPage tk = ps2.finishPaymentWithSelectBank();
