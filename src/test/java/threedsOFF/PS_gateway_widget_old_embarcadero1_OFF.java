...
public class PS_gateway_widget_old_embarcadero1_OFF  extends BaseTest_Z2 {
...
//	String url = "http://feature-ccg-843.wallapi.bamboo.stuffio.com";
	...
	String a_id = "101677";
	int ps_id = 132;
	String host = AnnotationPage.WallapiUrl.host(url).widget(widget).a_id(a_id).co_id(co_id).isCustom("email", "meo+meo%40spam4.me").generate();
