...
public class PS_gateway_fp_custom_1v5_embarcalero2_ON2  extends BaseTest_Z2 {
	
	String shortcode = "gateway";
//	String url = "http://feature-pwg-1139.wallapi.bamboo.stuffio.com";
	String co_id = "76";
	String a_id = "101696";
	String host = url +"/test-staging-brick/1.5/brick-custom-fp.html?iframe=true";
	int ps_id = 132;
