...
public class PS_gateway_widget_brick_1v5_embarcalero1_ON  extends BaseTest_Z2 {
...
//	String url = "http://feature-bt2-116.wallapi.bamboo.stuffio.com";
	String host = AnnotationPage.WallapiUrl.host(url).widget(widget).isPrice(price, currency).co_id(co_id).isUidTimeline().a_id(a_id).generate();
